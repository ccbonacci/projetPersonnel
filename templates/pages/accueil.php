...
<div class="container">
    ...
    <div class="col-lg-10 col-med-10 col-sm-11">
      ...
      <div class="row">
        <div class="col-lg-6 col-med-6 col-sm-12">
          <p>Vous souhaitez former une développeuse web à la culture de votre entreprise par le biais de l'alternance ? Vous recherchez un profil motivé, pleine de  curiosité et dynamique ? Rencontrons nous !</p>
        </div>
        <div class="col-lg-6 col-med-6 col-sm-12">
          <p>En challenge professionnel depuis deux ans, j'ai découvert le développement Web que je trouve vraiment stimulant. Je n'excelle pas encore, ni en front ni en back, mais je suis passionnément curieuse. Mon objectif devenir une développeuse full stack. Pour cela, je recherche toute collaboration avec une équipe de super-développeurs qui me permettra d'apprendre et de relever différents challenges dans la joie et la bonne humeur.</p>
        </div>
      </div>
    </div>

    <div class="col-lg-10 col-med-10 col-sm-11">
      <h2>And in english please !</h2>
      <div class="row ">
        <div class="col-lg-6 col-med-6 col-sm-12">
  ...
  <div id="id01">Ici un exercice pour importer du contenu d'un site via un script en javascript</div>
  <div>
    <div class="col-med-2">
